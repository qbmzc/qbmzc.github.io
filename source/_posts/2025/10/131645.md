...
**问题URL：**
```bash
http://hls.ixxx.test.xxx.com/resources/hls/8ac0804d99eb075b019a0495da090003/8ac0804d99eb075b019a0495da090003_1080p.m3u8
```
...
```bash
# 模拟浏览器请求测试
curl -o a.m3u8 -v 'http://hls.ixxx.test.xxx.com/resources/hls/8ac0804d99eb075b019a0495da090003/8ac0804d99eb075b019a0495da090003_1080p.m3u8' \
  -H 'Accept: */*' \
...
- **Ping测试**：`ping -c 5 hls.ixxx.test.xxx.com` 速度正常
...
```bash
# 检查 DNS 解析时间
nslookup hls.ixxx.test.xxx.com

# 使用dig获取更详细信息
dig hls.ixxx.test.xxx.com

# 检查解析时间
dig +trace hls.ixxx.test.xxx.com
```
...
```bash
# 编辑 /etc/hosts
echo "10.64.11.116 hls.ixxx.test.xxx.com" >> /etc/hosts
```

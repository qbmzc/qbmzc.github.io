...
public class HeaderFooterParam {
    ...
    @NotNull
    @ApiModelProperty(value = "位置，左（LEFT）、右(RIGHT)、中间(CENTER)，一个位置只能添加一个", dataType = "com.xxxtech.paas.fs.common.dto.headerfooter.Position", required = true, example = "CENTER")
